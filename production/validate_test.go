	...
	tests := []struct {
		...
		{"extReq", &go3mf.Model{Specs: map[string]go3mf.Spec{ExtensionSpace: &Extension{IsRequired: true}},
			...
			Resources: go3mf.Resources{Objects: []*go3mf.Object{
				{ID: 5, AnyAttr: go3mf.AnyAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d481")}, Components: []*go3mf.Component{
					{ObjectID: 1, AnyAttr: go3mf.AnyAttr{
						&PathUUID{Path: "/other.model", UUID: UUID("f47ac10b-58cc-0372-8567-0e02b2c3d480")},
					}}}}}}, Build: go3mf.Build{
				AnyAttr: go3mf.AnyAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d479")}, Items: []*go3mf.Item{
					{ObjectID: 1, AnyAttr: go3mf.AnyAttr{&PathUUID{UUID: UUID("f47ac10b-58cc-0372-8567-0e02b2c3d478"), Path: "/other.model"}}},
				}}}, []error{
		...
		{"items", &go3mf.Model{Build: go3mf.Build{
			AnyAttr: go3mf.AnyAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d479")}, Items: []*go3mf.Item{
				{ObjectID: 1, AnyAttr: go3mf.AnyAttr{&PathUUID{UUID: UUID("f47ac10b-58cc-0372-8567-0e02b2c3d478"), Path: "/other.model"}}},
				{ObjectID: 1},
				{ObjectID: 1, AnyAttr: go3mf.AnyAttr{&PathUUID{UUID: ""}}},
				{ObjectID: 1, AnyAttr: go3mf.AnyAttr{&PathUUID{UUID: "a-b-c-d"}}},
			}},
			Childs:    map[string]*go3mf.ChildModel{"/other.model": {Resources: go3mf.Resources{Objects: []*go3mf.Object{validMesh}}}},
		...
		{"components", &go3mf.Model{Resources: go3mf.Resources{
			Objects: []*go3mf.Object{
				{ID: 2, Mesh: validMesh.Mesh, AnyAttr: go3mf.AnyAttr{mustUUID("a-b-c-d")}},
				{ID: 3, AnyAttr: go3mf.AnyAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d483")}, Components: []*go3mf.Component{
					{ObjectID: 2, AnyAttr: go3mf.AnyAttr{&PathUUID{UUID: UUID("")}}},
					{ObjectID: 2, AnyAttr: go3mf.AnyAttr{&PathUUID{UUID: UUID("a-b-c-d")}}},
				}},
			},
		}, Build: go3mf.Build{AnyAttr: go3mf.AnyAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d479")}}}, []error{
		...
		{"child", &go3mf.Model{Build: go3mf.Build{AnyAttr: go3mf.AnyAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d479")}},
			Childs: map[string]*go3mf.ChildModel{
				...
				"/other.model": {Resources: go3mf.Resources{Objects: []*go3mf.Object{
					{ID: 2, Components: []*go3mf.Component{
						{ObjectID: 1, AnyAttr: go3mf.AnyAttr{&PathUUID{Path: "/b.model"}}},
					}},
				}}}}}, []error{
