...
func TestValidate(t *testing.T) {
	validMesh := &go3mf.Object{ID: 1, Mesh: &go3mf.Mesh{Vertices: []go3mf.Point3D{{}, {}, {}, {}}, Faces: []go3mf.Face{
	...
	tests := []struct {
		...
		{"extReq", &go3mf.Model{ExtensionSpecs: map[string]go3mf.ExtensionSpec{ExtensionSpace: &Extension{IsRequired: true}},
		...
		{"child", &go3mf.Model{Build: go3mf.Build{ExtensionAttr: go3mf.ExtensionAttr{mustUUID("f47ac10b-58cc-0372-8567-0e02b2c3d479")}},
