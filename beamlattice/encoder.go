...
func (m *BeamLattice) Marshal3MF(x specxml.Encoder) error {
...
func marshalBeamsets(x specxml.Encoder, m *BeamLattice) {
...
func marshalBeams(x specxml.Encoder, m *BeamLattice) {
