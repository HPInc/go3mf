...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{"rels", &Model{Attachments: []Attachment{{Path: "/a.png"}}, Relationships: []Relationship{
			...
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[0]: %v", errors.ErrOPCPartName),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[1]: %v", errors.ErrOPCPartName),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[3]: %v", errors.ErrOPCPartName),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[4]: %v", errors.ErrOPCRelTarget),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[5]: %v", errors.ErrOPCDuplicatedRel),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[6]: %v", errors.ErrOPCContentType),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[7]: %v", errors.ErrOPCDuplicatedRel),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[7]: %v", errors.ErrOPCContentType),
			fmt.Sprintf("/3D/3dmodel.model/model/relationship[7]: %v", errors.ErrOPCDuplicatedTicket),
		}},
		{"namespaces", &Model{Extensions: []Extension{{Namespace: "fake", LocalName: "f", IsRequired: true}}}, []string{
			fmt.Sprintf("model: %v", errors.ErrRequiredExt),
		}},
		{"metadata", &Model{Extensions: []Extension{{Namespace: "fake", LocalName: "f"}}, Metadata: []Metadata{
			...
			fmt.Sprintf("model/metadata[1]: %v", errors.ErrMetadataNamespace),
			fmt.Sprintf("model/metadata[2]: %v", errors.ErrMetadataDuplicated),
			fmt.Sprintf("model/metadata[3]: %v", errors.ErrMetadataName),
			fmt.Sprintf("model/metadata[4]: %v", &errors.MissingFieldError{Name: attrName}),
		}},
		{"build", &Model{Resources: Resources{Assets: []Asset{&BaseMaterials{ID: 1, Materials: []Base{{Name: "a", Color: color.RGBA{A: 1}}}}}, Objects: []*Object{
			...
			"model: Build: fake",
			fmt.Sprintf("model/build/item[0]: %v", &errors.MissingFieldError{Name: attrObjectID}),
			fmt.Sprintf("model/build/item[1]: %v", errors.ErrOtherItem),
			fmt.Sprintf("model/build/item[2]: %v", errors.ErrMissingResource),
			fmt.Sprintf("model/build/item[3]: %v", errors.ErrMissingResource),
			fmt.Sprintf("model/build/item[3]/metadata[0]: %v", errors.ErrMetadataName),
		}},
		{"childs", &Model{Childs: map[string]*ChildModel{DefaultModelPath: {}, "/a.model": {
			...
			[]string{
				fmt.Sprintf("model: %v", errors.ErrOPCDuplicatedModelName),
				fmt.Sprintf("/a.model/model/relationship[0]: %v", errors.ErrOPCPartName),
				fmt.Sprintf("/a.model/model/resources/object[0]: %v", errors.ErrMissingID),
				fmt.Sprintf("/a.model/model/resources/object[0]: %v", errors.ErrInvalidObject),
			}},
		{"assets", &Model{Resources: Resources{Assets: []Asset{
			...
			fmt.Sprintf("model/resources/basematerials[0]: %v", errors.ErrMissingID),
			fmt.Sprintf("model/resources/basematerials[0]/base[0]: %v", &errors.MissingFieldError{Name: attrName}),
			fmt.Sprintf("model/resources/basematerials[0]/base[0]: %v", &errors.MissingFieldError{Name: attrDisplayColor}),
			fmt.Sprintf("model/resources/basematerials[2]: %v", errors.ErrDuplicatedID),
			fmt.Sprintf("model/resources/basematerials[2]: %v", errors.ErrEmptyResourceProps),
		}},
		{"objects", &Model{Resources: Resources{Assets: []Asset{
			...
			fmt.Sprintf("model/resources/object[0]: %v", errors.ErrMissingID),
			fmt.Sprintf("model/resources/object[0]: %v", errors.ErrInvalidObject),
			fmt.Sprintf("model/resources/object[1]: %v", errors.ErrDuplicatedID),
			fmt.Sprintf("model/resources/object[1]: %v", &errors.MissingFieldError{Name: attrPID}),
			fmt.Sprintf("model/resources/object[1]: %v", errors.ErrInvalidObject),
			fmt.Sprintf("model/resources/object[1]/mesh: %v", errors.ErrInsufficientVertices),
			fmt.Sprintf("model/resources/object[1]/mesh: %v", errors.ErrInsufficientTriangles),
			fmt.Sprintf("model/resources/object[1]/components/component[0]: %v", errors.ErrRecursion),
			fmt.Sprintf("model/resources/object[3]: %v", errors.ErrComponentsPID),
			fmt.Sprintf("model/resources/object[3]/components/component[0]: %v", errors.ErrRecursion),
			fmt.Sprintf("model/resources/object[3]/components/component[2]: %v", &errors.MissingFieldError{Name: attrObjectID}),
			fmt.Sprintf("model/resources/object[3]/components/component[3]: %v", errors.ErrMissingResource),
			fmt.Sprintf("model/resources/object[3]/components/component[4]: %v", errors.ErrMissingResource),
			fmt.Sprintf("model/resources/object[4]: %v", errors.ErrMissingResource),
			fmt.Sprintf("model/resources/object[4]/mesh: %v", errors.ErrInsufficientVertices),
			fmt.Sprintf("model/resources/object[4]/mesh: %v", errors.ErrInsufficientTriangles),
			fmt.Sprintf("model/resources/object[4]/mesh/triangle[0]: %v", errors.ErrDuplicatedIndices),
			fmt.Sprintf("model/resources/object[4]/mesh/triangle[1]: %v", errors.ErrDuplicatedIndices),
			fmt.Sprintf("model/resources/object[4]/mesh/triangle[2]: %v", errors.ErrDuplicatedIndices),
			fmt.Sprintf("model/resources/object[5]: %v", errors.ErrIndexOutOfBounds),
			...
			fmt.Sprintf("model/resources/object[5]/mesh/triangle[3]: %v", errors.ErrMissingResource),
		}},
	}
