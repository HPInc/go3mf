...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{"extRequired", &go3mf.Model{
			AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{SliceStackID: 10}},
			Specs:   map[string]go3mf.Spec{Namespace: &Spec{IsRequired: true}}, Resources: go3mf.Resources{
				...
				Objects: []*go3mf.Object{
					{ID: 2, AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
		...
		{"info", &go3mf.Model{Build: go3mf.Build{Items: []*go3mf.Item{
			...
			Childs: map[string]*go3mf.ChildModel{
				...
				Objects: []*go3mf.Object{
					{ID: 1, Mesh: &go3mf.Mesh{}, AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
						SliceStackID: 1,
					}}},
					{ID: 2, Type: go3mf.ObjectTypeSupport, Components: []*go3mf.Component{{ObjectID: 1}}, AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
					...
					{ID: 4, Components: []*go3mf.Component{{ObjectID: 10, Transform: go3mf.Matrix{2, 3, 0, 0, 1, 3, 0, 0, 0, 0, 2, 0, 2, 3, 4, 1}}},
						AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
							SliceStackID: 0,
						}}},
					{ID: 5, Components: []*go3mf.Component{{ObjectID: 12}}, AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
						SliceStackID: 6,
					}}},
					{ID: 7, Components: []*go3mf.Component{{ObjectID: 1}, {ObjectID: 4}}, AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
						SliceStackID: 9,
					}}},
					{ID: 10, Type: go3mf.ObjectTypeSolidSupport, Components: []*go3mf.Component{{ObjectID: 1}}, AnyAttr: go3mf.ExtensionsAttr{&SliceStackInfo{
						SliceStackID: 3,
					}}},
