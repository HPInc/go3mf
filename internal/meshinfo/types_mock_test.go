...
// Source: github.com/qmuntal/go3mf/internal/meshinfo (interfaces: FaceData,Container,TypedInformer,FaceQuerier,Handleable)
...
type MockHandleable struct {
	ctrl     *gomock.Controller
	recorder *MockHandleableMockRecorder
}

// MockHandleableMockRecorder is the mock recorder for MockHandleable
type MockHandleableMockRecorder struct {
	mock *MockHandleable
}

// NewMockHandleable creates a new mock instance
func NewMockHandleable(ctrl *gomock.Controller) *MockHandleable {
	mock := &MockHandleable{ctrl: ctrl}
	mock.recorder = &MockHandleableMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockHandleable) EXPECT() *MockHandleableMockRecorder {
	return m.recorder
}
...
// AddFaceData indicates an expected call of AddFaceData
func (mr *MockHandleableMockRecorder) AddFaceData(arg0 interface{}) *gomock.Call {
...
// InfoType indicates an expected call of InfoType
func (mr *MockHandleableMockRecorder) InfoType() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InfoType", reflect.TypeOf((*MockHandleable)(nil).InfoType))
}
...
// clone indicates an expected call of clone
func (mr *MockHandleableMockRecorder) clone(arg0 interface{}) *gomock.Call {
...
func (mr *MockHandleableMockRecorder) permuteNodeInformation(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "permuteNodeInformation", reflect.TypeOf((*MockHandleable)(nil).permuteNodeInformation), arg0, arg1, arg2, arg3)
}
...
func (mr *MockHandleableMockRecorder) resetFaceInformation(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "resetFaceInformation", reflect.TypeOf((*MockHandleable)(nil).resetFaceInformation), arg0)
}
...
func (mr *MockHandleableMockRecorder) setInternalID(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "setInternalID", reflect.TypeOf((*MockHandleable)(nil).setInternalID), arg0)
}
